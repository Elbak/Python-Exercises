...
c.Periods followed by whitespace and then an upper case letter, but preceded by any of a short
    list of titles are not sentence boundaries. Sample titles include Mr., Mrs., Dr., and so on.
...
e.Periods followed by certain kinds of punctuation (notably comma and more periods) are probably
